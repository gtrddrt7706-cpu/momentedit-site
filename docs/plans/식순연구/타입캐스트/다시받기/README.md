...
node scripts/assemble-narration.mjs --in <진희_받은폴더> \
  --clip =01_guest-1-arrival,=02_guest-2-10min,=03_guest-3-5min,=04_guest-4-1min,=85_narr-photo-send,=44_end-0-photo,=45_end-1a-farewell,=47_end-2-goodbye,=48_online-3-welcome
```
