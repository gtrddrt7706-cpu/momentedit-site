...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'narr-photo-ask': '오늘 찍으신 사진은 나중에 두 사람에게 보내 주실 수 있습니다. 같은 순간도, 앉으신 자리마다 다르게 보입니다.',
    /* ★[PHOTO_ASK] 버튼 이름을 낫표로 인용하지 않는다 — 타입캐스트가 괄호·낫표를 읽는다.
       이름을 부르는 대신 «보내 주시면 전해집니다»로 행동만 말한다. */
    'narr-photo-send': '담아 두신 오늘은 두 사람에게 바로 갑니다. 받으신 안내 페이지에서 올려 주세요.',
    ...
    'narr-toast-none': '오늘은 축사를 따로 두지 않았습니다. 여기 계신 분들이 이미 두 사람을 잘 아십니다.',
    ...
    'end-1a-farewell': '오늘의 예식은 여기까지입니다. 편히 움직이셔도 좋습니다. 두고 가시는 물건이 없는지만 한 번 살펴 주시기 바랍니다.',
    ...
    'end-1b-farewell-online': '오늘의 예식은 여기까지입니다. 편히 움직이셔도 좋습니다. 두고 가시는 물건이 없는지만 한 번 살펴 주시기 바랍니다. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 자리를 지켜 주신 여러분께 감사드립니다. 여러분이 계셔서 두 사람의 처음이 외롭지 않았습니다. 돌아가시는 길 편안하시기 바랍니다.',
    'online-3-welcome': '화면으로 보고 계신 분들, 반갑습니다. 멀리 계셔도 오늘을 같이 보시라고 연 자리입니다. 같은 시간에 계신 것으로 충분합니다.',
    'bridge-4-wait-emotion': '잠시 이대로 두겠습니다. 오늘은 서두를 일이 없습니다.',
    'bridge-5-wait-setup': '준비가 조금 남아 잠시 쉬어 가겠습니다. 금방 이어집니다.',
