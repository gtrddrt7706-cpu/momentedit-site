...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'narr-photo-ask': '오늘은 마음껏 찍으셔도 좋습니다. 같은 순간도, 앉으신 자리마다 다르게 남습니다.',
    ...
    'end-1a-farewell': '오늘의 기록이 모두 담겼습니다. 두 사람이 문 앞에서 인사드리겠습니다. 나가시는 길에 편히 인사 나누고 가시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요.',
    ...
    'end-1b-farewell-online': '오늘의 기록이 모두 담겼습니다. 두 사람이 문 앞에서 인사드리겠습니다. 나가시는 길에 편히 인사 나누고 가시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 함께해 주셔서 감사합니다. 여러분이 계셔서 두 사람의 처음이 외롭지 않았습니다. 돌아가시는 길 편안하시기 바랍니다.',
