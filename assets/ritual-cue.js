...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    /* ★[MEAL_GUIDE] 진희(안내) · 합쇼체. 「입구에서 안내」의 근거는 문 앞 배웅 줄에 선 직원이다
       — 45 의 live(「하객 배웅 · 문 앞에서 인사」)와 같은 자리다. */
  ...
  function build(S0, opts) {
    ...
    if (mode === 'console') {
      ...
      if (S.meal) cues.push(cue({
        k: '_farewell', blockN: '배웅', slug: 'guide-meal', name: '식사 자리 안내',
        text: EXTRA['guide-meal'], duck: -14, fire: 'chain',
        note: '애프터 웨딩에서 모일 식당을 고른 날만 나간다'
      }));
