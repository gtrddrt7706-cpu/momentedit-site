...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'narr-photo-send': '사진은 받으신 안내 페이지에 올려 주시면, 두 사람에게 바로 전해집니다.',
    ...
    'end-1a-farewell': '오늘의 예식은 여기까지입니다. 편히 움직이셔도 좋습니다. 두고 가시는 물건이 없는지만 한 번 살펴 주십시오.',
    ...
    'end-1b-farewell-online': '오늘의 예식은 여기까지입니다. 편히 움직이셔도 좋습니다. 두고 가시는 물건이 없는지만 한 번 살펴 주십시오. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 자리를 지켜 주신 여러분께 감사드립니다. 여러분이 계셔서 두 사람의 처음이 외롭지 않았습니다. 돌아가시는 길 편안하시기 바랍니다.',
    'online-3-welcome': '화면으로 보고 계신 분들, 반갑습니다. 이 하루를, 두 사람은 여러분과도 나누고 싶었습니다. 같은 시간에 계신 것으로 충분합니다.',
