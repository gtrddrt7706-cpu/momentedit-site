...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'end-0-photo': '여기서부터는 작가님이 안내해 드립니다.',
    'end-1a-farewell': '오늘의 예식은 여기까지입니다. 편히 일어나셔서 움직이세요. 두고 가시는 물건이 없는지만 한 번 살펴 주시기 바랍니다.',
    ...
    'end-1b-farewell-online': '오늘의 예식은 여기까지입니다. 편히 일어나셔서 움직이세요. 두고 가시는 물건이 없는지만 한 번 살펴 주시기 바랍니다. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 자리를 지켜 주신 여러분께 감사드립니다. 여러분이 계셔서 두 사람의 처음이 외롭지 않았습니다. 돌아가시는 길 편안하시기 바랍니다.',
    'online-3-welcome': '화면으로 보고 계신 분들, 반갑습니다. 멀리 계신 분도 오늘을 같이 보시라고 연 자리입니다. 같은 시간에 계신 것으로 충분합니다.',
