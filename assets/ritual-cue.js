...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'end-1a-farewell': '오늘의 예식은 여기까지입니다. 편히 일어나셔서, 천천히 움직이시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요.',
    ...
    'end-1b-farewell-online': '오늘의 예식은 여기까지입니다. 편히 일어나셔서, 천천히 움직이시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 함께해 주셔서 감사합니다. 오늘 여러분과 함께한 이 자리가, 두 사람의 시작입니다. 돌아가시는 길 편안하시기 바랍니다.',
