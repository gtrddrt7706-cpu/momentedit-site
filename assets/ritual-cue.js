...
(function (root, factory) {
  ...
  var EXTRA = {
    ...
    'end-0-photo': '여기서부터는 작가님이 안내해 드립니다. 서두르지 않으셔도 됩니다.',
    'end-1a-farewell': '이제 두 사람이 문 앞에서 인사드리겠습니다. 나가시는 길에 편히 인사 나누고 가시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요.',
    ...
    'end-1b-farewell-online': '이제 두 사람이 문 앞에서 인사드리겠습니다. 나가시는 길에 편히 인사 나누고 가시면 됩니다. 두고 오신 물건이 없는지만 한 번 살펴 주세요. 화면으로 함께해 주신 분들께도, 두 사람이 곧 인사드리겠습니다.',
    'end-2-goodbye': '끝까지 함께해 주셔서 감사합니다. 여러분이 앉아 계셨던 그 자리가, 두 사람의 처음입니다. 돌아가시는 길 편안하시기 바랍니다.',
