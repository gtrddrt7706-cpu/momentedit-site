...
(function () {
  ...
  var ROWS = [
    ...
    /* ★[TIME_HONEST] 시각이 길이와 맞지 않았다 — 2026-08-08 실측.
       ...
       ★'신랑·신부 입장' 줄을 없애고 본식이 입장으로 시작하게 했다 — MIN.base(16~24)가 이미
    ...
    ['본식', '20분', ['10:05', '13:25', '16:45'], '두 분의 입장으로 시작해요. 고른 코스에 따라 16~24분으로 달라지고, 이벤트 2~4개로 채워지는 예식의 중심이에요.'],   // [TIME_HONEST]
    ['인사 사진', '35분', ['10:25', '13:45', '17:05'], '본식이 끝나는 대로 이어져요 · 신부대기실에서 기다리는 시간 대신, 두 분이 자리마다 찾아가 인사드리고 그 테이블에서 바로 한 장을 남겨요. 작가가 함께 다니니 원하는 컷을 부탁하셔도 되고, 폰 셀카도 좋아요. 본식이 짧으면 그만큼 여기가 길어져 31~39분이에요.'],   // [TIME_HONEST]
