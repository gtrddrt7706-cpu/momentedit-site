...
(function () {
  ...
  var ROWS = [
    ...
    ['하객 입장', '20분', ['09:45', '13:05', '16:25'], '하객분들이 입장하며 웰컴 와인과 좌석 안내를 받는 시간이에요.', true],
    ...
    ['하객과 함께', '31~39분', ['10:25', '13:45', '17:05'], '본식이 끝나는 대로 이어져요 · 단체 기록을 남기고, 두 분이 자리마다 찾아가 인사드려요. 본식이 짧으면 그만큼 여기가 길어져요.'],   // [TIME_HONEST]
