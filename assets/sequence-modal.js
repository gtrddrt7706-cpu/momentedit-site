...
(function () {
  ...
  var ROWS = [
    ...
    ['하객 입장', '20분', ['10:00', '13:20', '16:40'], '하객분들이 입장하며 웰컴 음료와 좌석 안내를 받는 시간이에요. 예식 시작 4분 전에는 불을 낮추고 두 분의 영상을 틀어요.', true],   // [SNAP_50] 식전 영상은 늘 있다(사장님 결정 2)
    ...
    ['본식', '8~25분쯤', ['10:20', '13:40', '17:00'], '두 분의 입장으로 시작해요. 담은 순간에 따라 길이가 달라지는 예식의 중심이에요 · 순서는 저희가 맞춰요.'],   // [TIME_HONEST]
