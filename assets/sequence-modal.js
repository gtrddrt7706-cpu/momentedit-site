...
(function () {
  ...
  var ROWS = [
    ...
    /* ★[TIME_HONEST] 시각이 길이와 맞지 않았다 — 2026-08-08 실측.
       ...
       ★고친 방식: '신랑·신부 입장' 줄을 없애고 본식이 입장으로 시작하게 했다.
         MIN.base(16~24)가 이미 입장(entry)을 포함한 값이라, 따로 5분을 더하면 두 번 세는 것이다.
         본식+인사와사진 = 60분 고정이므로 배웅은 어떤 코스에서도 11:00 · 종료 11:20 그대로.
         인사와 사진의 10:20 은 본식 20분(가운데) 기준 — 실제로는 10:16~10:24 사이에 시작한다. */
    ['본식', '16~24분', ['10:00', '13:20', '16:40'], '두 분의 입장으로 시작해요. 고른 코스에 따라 길이가 달라지고, 이벤트 2~4개로 채워지는 예식의 중심이에요.'],   // [TIME_HONEST]
    ['인사와 사진', '36~44분', ['10:20', '13:40', '17:00'], '본식이 끝나는 대로 이어져요 · 단체 기록을 남기고, 두 분이 자리마다 찾아가 인사드려요. 본식이 짧으면 그만큼 여기가 길어져요.'],   // [TIME_HONEST]
