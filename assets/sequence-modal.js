...
(function () {
  ...
  var ROWS = [
    ...
    ['본식', '16~24분', ['10:05', '13:25', '16:45'], '고른 코스에 따라 달라져요 · 이벤트 2~4개로 채워지는 예식의 중심이에요.'],   // [TIME_HONEST]
    ['인사와 사진', '36~44분', ['10:30', '13:50', '17:10'], '단체 기록을 남기고, 두 분이 자리마다 찾아가 인사드려요 · 본식이 짧아진 만큼 여기가 늘어나요.'],   // [TIME_HONEST]
