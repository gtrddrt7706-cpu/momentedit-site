...
(function () {
  ...
  var ROWS = [
    ...
    ['본식', '약 20분', ['10:05', '13:25', '16:45'], '두 분의 입장으로 시작해요. 고른 코스에 따라 16~24분으로 달라지고, 이벤트 2~4개로 채워지는 예식의 중심이에요.'],   // [TIME_HONEST]
    ['하객과 함께', '약 35분', ['10:25', '13:45', '17:05'], '본식이 끝나는 대로 이어져요 · 단체 기록을 남기고, 두 분이 자리마다 찾아가 인사드려요. 본식이 짧으면 그만큼 여기가 길어져 31~39분이에요.'],   // [TIME_HONEST]
