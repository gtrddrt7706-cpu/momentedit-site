...
(function () {
  ...
  var ROWS = [
    ...
    ['단독 스냅 촬영', '50분', ['09:20', '12:40', '16:00'], '하객과 분리된 캔들존·화이트존에서 두 분만의 화보 같은 스냅을 담아요. 캔들존 20분 · 이동 5분 · 화이트존 20분 · 입장 준비 5분이에요.'],   // [SNAP_50 2026-09-25]
    ['하객 입장', '20분', ['09:50', '13:10', '16:30'], '하객분들이 입장하며 웰컴 음료와 좌석 안내를 받는 시간이에요. 예식 시작 4분 전에는 불을 낮추고 두 분의 영상을 틀어요.', true],   // [SNAP_50] 식전 영상은 늘 있다(사장님 결정 2)
    ...
    ['본식', '12~25분쯤', ['10:10', '13:30', '16:50'], '두 분의 입장으로 시작해요. 담은 순간에 따라 길이가 달라지는 예식의 중심이에요 · 순서는 저희가 맞춰요.'],   // [TIME_HONEST]
    ['인사 사진', '25~38분쯤', ['10:30', '13:50', '17:10'], '두 분이 자리마다 찾아가 인사를 나눠요 · 그 테이블에서 한 장씩, 폰 사진도 편하게. 작가가 함께 다니니 원하는 컷을 부탁하셔도 돼요. 마지막엔 다 함께 모여 단체사진을 여러 구도로 남겨요. 본식이 짧으면 그만큼 여기가 길어져요.'],   // [TIME_HONEST]
