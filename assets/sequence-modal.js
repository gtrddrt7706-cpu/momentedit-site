...
(function () {
  ...
  var ROWS = [
    ...
    ['본식', '10~30분쯤', ['10:05', '13:25', '16:45'], '두 분의 입장으로 시작해요. 담은 순간에 따라 길이가 달라지는 예식의 중심이에요 · 순서는 저희가 맞춰요.'],   // [TIME_HONEST]
    ['인사 사진', '25~45분쯤', ['10:25', '13:45', '17:05'], '두 분이 자리마다 찾아가 인사를 나눠요 · 그 테이블에서 한 장씩, 폰 사진도 편하게. 작가가 함께 다니니 원하는 컷을 부탁하셔도 돼요. 마지막엔 다 함께 모여 단체사진을 여러 구도로 남겨요. 본식이 짧으면 그만큼 여기가 길어져요.'],   // [TIME_HONEST]
