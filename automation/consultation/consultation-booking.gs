...
function emailShell(headline, innerHtml) {
  return '' +
    '<!DOCTYPE html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><meta name="supported-color-schemes" content="light"><style>:root{color-scheme:only light;supported-color-schemes:only light}html,body{color-scheme:only light}body{margin:0;padding:0;background:#FAFAF8 !important}.me-card{padding:46px 38px}@media only screen and (max-width:600px){.me-card{padding:36px 22px !important}}@media (prefers-color-scheme:dark){body,.me-bg{background:#FAFAF8 !important}.me-card{background:#FFFFFF !important;color:#3A2D22 !important}}</style></head>' +
    '<body style="margin:0;padding:0;background:#FAFAF8;color-scheme:only light;">' +
