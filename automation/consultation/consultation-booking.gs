...
// [다크 프레임] 애플 메일 방식 — 바깥(로고·푸터)은 다크, 콘텐츠 카드는 화이트.
//   Gmail 앱은 라이트 메일만 강제 다크 변환하고 "이미 어두운 메일"은 건드리지 않는 휴리스틱 →
//   프레임을 다크로 두면 흰 카드까지 원본 그대로 살아남고, 혹시 변환돼도 프레임이 이미 다크라 디자인이 안 깨짐(양쪽 안전).
//   카드 내부(각 메일 본문)는 기존 화이트 기준 스타일 그대로 사용.
function emailShell(headline, innerHtml) {
  return '' +
    '<!DOCTYPE html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><meta name="supported-color-schemes" content="light"><link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;1,500&family=Noto+Serif+KR:wght@300;400;500;600&display=swap" rel="stylesheet"><style>@import url(\'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,500;1,500&family=Noto+Serif+KR:wght@300;400;500;600&display=swap\');:root{color-scheme:only light;supported-color-schemes:only light}html,body{color-scheme:only light}body{margin:0;padding:0;background:#16120E !important}.me-card{padding:42px 38px}@media only screen and (max-width:600px){.me-card{padding:34px 22px !important}}@media (prefers-color-scheme:dark){body,.me-bg{background:#16120E !important}.me-card{background:#FFFFFF !important;color:#3A2D22 !important}}[data-ogsb] body,[data-ogsb] .me-bg{background:#16120E !important}[data-ogsb] .me-card{background:#FFFFFF !important}[data-ogsc] .me-card{color:#3A2D22 !important}</style></head>' +
    '<body bgcolor="#16120E" style="margin:0;padding:0;background:#16120E;color-scheme:only light;">' +
    '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#16120E;width:100%;"><tr><td align="center" bgcolor="#16120E" class="me-bg" style="background:#16120E;padding:36px 16px 30px;">' +
    '<table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;"><tr><td align="center" style="padding:6px 0 26px;"><img src="https://raw.githubusercontent.com/gtrddrt7706-cpu/momentedit-site/main/logogold.png" alt="Moment Edit" width="200" style="width:200px;max-width:62%;height:auto;display:inline-block;border:0;outline:none;text-decoration:none;"><div style="font-family:\'Cormorant Garamond\',serif;font-size:10px;letter-spacing:.3em;color:#8A7A5E;text-transform:uppercase;margin-top:10px">Private Wedding Studio</div></td></tr></table>' +
    '<table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;background:#FFFFFF;border-radius:10px;"><tr><td bgcolor="#FFFFFF" class="me-card" style="background:#FFFFFF;border-radius:10px;padding:42px 38px;font-family:\'Noto Serif KR\',serif;color:#3A2D22;">' +
      ...
      innerHtml +
    '</td></tr></table>' +
    '<table role="presentation" width="560" cellpadding="0" cellspacing="0" border="0" style="max-width:560px;width:100%;"><tr><td align="center" style="padding:24px 10px 6px;"><div style="font-family:\'Cormorant Garamond\',serif;font-style:italic;font-size:11.5px;color:#B89A75;">Focus on the Essence, Record the Truth.</div><div style="margin-top:8px;font-family:\'Noto Serif KR\',serif;font-size:10px;letter-spacing:.05em;color:#6E6254;">Moment Edit · Private Wedding Studio</div></td></tr></table>' +
