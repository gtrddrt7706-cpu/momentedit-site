...
chk '카카오톡과 메일로 알려드려요' mypage.html 1                # 대기 카드 알림 안내 문구(백엔드 알림이 근거) — 2026-07-26 사용자 지시로 한 줄 압축('준비되는 대로 하나씩, 카카오톡과 메일로 알려드려요' · 기능 유지)
...
chk 'RESULT_WAIT_POLISH' mypage.html 10               # cc-emo 여백 20/20 · dlv-sec .t 12px · vg-v 400 · cc-mini 대비 · 표 간격 10px · 원본 행 강조/기간 위치 · 부연 한 줄 압축 · 각주 중앙정렬 · 기간 우측 정렬 열 A안(전부 2026-07-26 사용자 지시)
