...
var CONTRACT = {
  version: '계약서명-v1',
  docVersion: 'v1.4',               // 계약서 '문서' 버전(시그니처) — v1.4(2026-08-08): 3조① 본식 16~24분·Group Record 36~44분(합 60분 고정). v1.3(2026-06-12): 예약금 100,000·계약금 잔액 납입·시착 2벌/5만. 서명 시 동의기록.계약.docVersion 스냅샷, 열람은 그 버전 문서로
