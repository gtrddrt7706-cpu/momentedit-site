...
var CONTRACT = {
  version: '계약서명-v1',
  docVersion: 'v1.7',               // 계약서 '문서' 버전(시그니처) — v1.7(2026-08-14): 금액 인상(주말 280→330만·평일 210→240만 · 계약 시 납입 잔액 18만→23만·11만→14만 · PRICE_2026_08 · 조항 무변경). v1.6(2026-08-13): 서명란에 AI 음성 안내 확인 줄 신설(★AI고지_부부 승인 자리 · CONTRACT_V16 · 조항 무변경). v1.5(2026-08-09): 3조① Private Snap 45분(캔들존 20·이동 5·화이트존 20)·본식 16~24분·Group Record 31~39분(합 55분 고정). v1.4(2026-08-08): 본식 16~24·GR 36~44(합 60). v1.3(2026-06-12): 예약금 100,000·계약금 잔액 납입·시착 2벌/5만. 서명 시 동의기록.계약.docVersion 스냅샷, 열람은 그 버전 문서로
