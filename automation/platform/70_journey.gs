...
var FITTING_CONSENT = {
  version: '시착동의-v2',   // v2(2026-06-12): 계약 후 청약철회·무상취소 시에도 전환분 제외(계약서 4조⑧·7조) 항목 추가 — 서명 시점 스냅샷이라 v1 서명자는 v1 기준 유지
  title: '드레스 시착 동의서',
  기본벌수: 3,
  ...
  terms: [
    ...
    '계약을 진행하신 뒤 청약철회(계약 후 15일 이내)나 무상취소(예식 150일 전까지)로 전액 환급을 받으시는 경우에도, 시착이 이미 진행되었다면 전환된 예약금 200,000원은 실제 제공된 시착 서비스의 대가로서 환급에서 제외됩니다. 그 외 받으신 금액은 전액 환급됩니다. (이용계약서 제4조 제8항 · 제7조)'
  ],
