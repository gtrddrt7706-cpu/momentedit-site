...
- 본식이 짧아진 만큼 뒤의 「하객과 함께」가 길어진다(하루 140분은 그대로). 짧은 코스는 손해가 아니다.`,
  ].join('\n');
}
...
- 예식 형태: 하객 약 25명 안팎의 마이크로웨딩 · 140분 시그니처 시퀀스(준비 20분 → 단독 스냅 45분 → 본식 16~24분 → 하객과 함께 31~39분 → 배웅 20분 · 본식이 짧은 코스를 고르면 그만큼 '하객과 함께'가 늘어나 하루 140분은 그대로) 안에서 본식이 진행된다. 진행 안내는 성우 나레이션과 디렉터가 맡아 사회자 없이도 매끄럽다(나레이션은 진행 수단).
