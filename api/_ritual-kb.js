...
- ★폐백은 예외 — 방침이 정해졌다(2026-09-12 사용자). 「별도의 폐백 순서는 두지 않는다」고 답한다.
  대신 부모님 헌정(큰절·꽃·포옹 중 택1)이 그 정서를 받는 자리다. 어른께 드리는 안내(parents.html)와 같은 말을 해야 한다.
...
- 별도의 폐백 순서는 없다 · 부모님 헌정(큰절·꽃 전달·포옹 중 택1)이 그 자리를 받는다.
