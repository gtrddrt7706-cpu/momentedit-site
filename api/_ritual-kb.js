...
function minLines() {
  ...
  return [
    ...
    // [VEIL_RETIRED 2026-08-03] 베일 다운 폐지 — 전 예식 동시입장이라 실행 불가. 되살리지 말 것.
    `- 옵션 증감: 밸리(와인/케이크) +${dl.valley}분 · 덕담 추가 +${dl.bless}분 · 링워밍 전체 하객 +${dl.ringwarmAll}분 · 축배+케이크 둘 다 +${dl.toastBoth}분 · 편지 양쪽(부모님+서로) +${dl.letterBoth}분 · 반지 빼면 ${dl.ringOff}분 · 첫인사 더하기 +${D.MIN.XM.welcome}분 · 편지 더하기 +${D.MIN.XM.letter}분 · 축가 더하기 +${D.MIN.XM.song}분`,
...
스텝: 시작 → 코스 선택 → 순간 고르기 → (코스별 순간들: 하객 맞이·입장·첫인사·서약·링워밍·반지·성혼 선언·밸리·축배/케이크·축가·편지·헌정·덕담) → 글 적어두기 → 완성.
