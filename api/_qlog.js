...
// '애매' = 답은 했지만 자신 없이 얼버무린 신호. 정상적 안내("담당자에게 전달하겠습니다" 등)는 오탐 안 되게 불확실 맥락만.
const SHAKY = /(정확하지\s?않을\s?수|정확히는\s?모르|확실하지\s?않|잘\s?모르겠|담당자에게\s?(문의|연락|확인)|직접\s?문의|안내\s?(가|를|드리기)\s?어렵|확인\s?후\s?안내|도움\s?드리기\s?어렵|답변\s?드리기\s?어렵|확인\s?(이|후)\s?(필요|부탁))/;
