...
- 다이닝 파트너 제안. 고객이 마이페이지에서 직접 선택하면 연락처·예약 안내 문구를 정리해 주고, 예약이 어려우면 디렉터가 도움.
- 의상 시착 3벌(디렉터 큐레이션).
- 성우 나레이션 + 식순 대본 가이드.
...
## 12. 식사 / 다이닝
- 스튜디오 인근 검증된 다이닝 파트너 제안. 고객이 마이페이지에서 마음에 드는 곳을 직접 선택 → 연락처·예약 안내 문구 정리. 예약이 어려우면 디렉터가 도움(대행 아님).
