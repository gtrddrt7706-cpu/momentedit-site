...
- 더미 커플은 **이서준 · 정하윤 (2027.12.17 금)** 로 고정 — 갤러리 인라인 라이브
...
# ============================================================
# 더미 커플 — 이서준 · 정하윤 / 2027.12.17(금) 10:00 / 스냅샷과 동일
# ============================================================
DATA = {
 ...
 # 날짜 — 2027.12.17 금요일
 'WEDDING_DATE_DISPLAY':'2027. 12. 17','WEDDING_DATE_KOR':'2027년 12월 17일','WEDDING_DATE_COMPACT':'20271217','WEDDING_DATE_SPACED':'2027 12 17',
 'WEDDING_DATE_LITERARY':'이천이십칠년 십이월 십칠일','WEDDING_MONTH_EN':'December 2027','WEDDING_MONTH_EN_SHORT':'Dec','WEDDING_MONTH_NAME_EN':'December','WEDDING_MONTH_NUM':'12','WEDDING_MONTH_NUM_PAD':'12',
 'WEDDING_MONTH_DAY_KOR':'12월 17일','WEDDING_DAY_OF_MONTH':'17','WEDDING_DAY_OF_MONTH_PAD':'17','WEDDING_DAY_KOR':'금요일','WEDDING_DAY_EN':'Friday','WEDDING_DAY_EN_SHORT':'Fri',
 'WEDDING_YEAR':'2027','WEDDING_YEAR_EN':'Two Thousand Twenty-Seven','WEDDING_YEAR_ROMAN':'MMXXVII','WEDDING_ISO_DATETIME':'2027-12-17T10:00:00+09:00',
 ...
 'GROOM_BIO':'특별하지 않은 하루도, 함께라 충분합니다.','BRIDE_BIO':'사랑한다는 말보다, 더 오래 곁에 있겠습니다.',
...
# ============================================================
# 캘린더 — 2027년 12월(1일=수요일), 결혼일 17일 marked
# ============================================================
def build_calendar_cells(year=2027, month=12, marked=17):
