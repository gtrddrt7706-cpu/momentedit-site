...
ok('ritual-data.js 로드(코스 7·NARR·MIN)', Object.keys(D.COURSES).length === 7 && !!D.NARR && !!D.MIN);   // [RECORD_COURSE] 기록형 추가로 5→6 · [OPEN_COURSE 2026-09-25] 새 코스 open 으로 6→7(옛 여섯은 hidden · 지우지 않는다)
