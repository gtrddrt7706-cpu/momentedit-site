...
//   한 번 철회했다가 되돌렸다 — ②*"왜 기존음성으로 입히지"* 를 「새것으로 바꿔라」로 읽은 내 오독이었다.
//   실제로는 「왜 기존 음성이 안 입혀지느냐」였다(화면 말과 나는 소리가 달랐다). ③이 그걸 확인해 줬다.
//   더빙본은 받아 두되 **표시만 하고 안 쓴다** — 조용히 버리면 나중에 아무도 못 찾는다.
//
...
const USE_EXISTING = '신랑 신부, 입장!';   // [USE_EXISTING] 이 자리는 기존 녹음을 쓴다
