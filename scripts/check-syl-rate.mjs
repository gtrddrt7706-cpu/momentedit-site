...
/* 벌어진 폭이 지금 수준(1.2~1.5배)을 벗어나면 알린다 — 성우가 바뀌었거나 상수를 손댔다는 뜻이다.
   ...
   ★★[TEXT_AHEAD 2026-09-12] 원인이 하나 더 있고, 그게 제일 흔하다 — «글을 고쳤는데 녹음이 옛 판»인 경우다.
     이 값은 (총 음절 ÷ 총 녹음 길이)다. 문안을 줄이면 음절만 줄고 길이는 그대로라 폭이 내려앉는다.
     실제로 2026-09-12 에 감동 구간을 줄이고 나서 1.18 로 떨어졌다.
