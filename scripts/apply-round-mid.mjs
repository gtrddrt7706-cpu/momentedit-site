...
//   (roundOpen 은 이미 31.5초에서 20.1초로 줄인 이력이 있다 · 지금 21.1초 · ROUND_LEN) 17분 뒤엔 어차피 잊힌다.
...
const E = [
  [DATA, '문안 추가', ' onlineIn:',
   ` /* ★★[ROUND_MID 2026-09-12] 인사 «돌기» 17분(라이브 1020초) 가운데에 디렉터가 트는 한 줄.
    ...
    ★여는 말(roundOpen)을 늘리지 «않는» 이유 — 그건 이미 31.5초에서 20.1초로 줄인 이력이 있고(지금 21.1초)
