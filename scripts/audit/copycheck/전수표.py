...
SKIP = {
 # ★★[TOAST_NONE 2026-09-20] 판정 회차 «뒤에» 태어난 클립이라 회차 기록에 없다.
 #   문안은 코워크가 냈고 사장님이 「첫째 안」으로 확정하셨다 — 즉 **이미 검토된 글**이다.
 #   ★이 자리를 「미착수」로 두면 «아직 아무도 안 본 글»과 구별이 안 된다. 그게 위험하다.
 #   ★새 클립이 생기면 여기 «누가 언제 정했는지»를 적는다. 안 적으면 다음 회차에 또 붉어진다.
 ('87','narr-toast-none'): '2026-09-20 신설 — 코워크 제안 · 사장님 「첫째 안」 확정. 판정 회차 뒤에 태어났다',
 ('88','guide-meal'): '2026-09-23 신설 — 코워크 세 눈 점검(신부·하객·혼주) · 사장님 반영 [MEAL_GUIDE]. 판정 회차 뒤에 태어났다',
 ('89','guest-4-1min-pre'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('90','narr-prevideo-in'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('91','narr-candle-in-mothers'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('92','narr-candle-in-parents'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('94','narr-candle-in-others'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('95','narr-candle-out'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('96','declare-clap-a'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('97','declare-clap-b'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('98','toast-pour-mix'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('99','toast-pour-family'): '2026-09-25 신설 — 코워크 설계 명세 1(식순 고르기 개편) 문안 그대로 [OPEN_COURSE]. 판정 회차 뒤에 태어났다',
 ('100','narr-free-in-video'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('101','narr-free-in-stage'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('102','narr-free-in-gift'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('103','narr-free-in-speech'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('104','narr-free-out-clap'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('105','narr-free-fail'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('106','tribute-bow-groom'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('107','toast-both-pour-b'): '2026-09-25 신설 — 코워크 회신 둘째 판(준비한 순서 판별 넷 · 재생 실패 · 신랑 큰절 · P2) 문안 그대로 [NAR_0925]. 판정 회차 뒤에 태어났다',
 ('108','narr-close-bow'): '2026-09-26 신설 — 코워크 회신5 4-2 초안 그대로 [CLOSE_BOW]. 판정 회차 뒤에 태어났다 · 사장님 대본 점검(7단계)에서 다듬는다',
 ('109','fx-free'): '2026-09-26 신설 — 코워크 회신 9/26 2-5 초안 그대로 [GROUP_PHOTO] · 골라 트는 판 «자유 사진». 판정 회차 뒤에 태어났다 · 사장님 대본 점검(7단계)에서 다듬는다',
 ('110','end-1c-thanks-nomeal'): '2026-09-26 신설 — 코워크 제안(고친 판) 1 · 덧 7 사장님 확인 글 그대로 [PHOTO_THANKS] [THANKS_TEXT] · 식사 없는 날 감사 인사. 판정 회차 뒤에 태어났다 · 사장님 녹음 도착(진희 6줄)',
 ('93','narr-candle-in-fathers'): '2026-09-25 신설 — ★명세에 «아버님» 판 문안이 없어 코드가 어머님 판 틀로 채웠다 · 코워크 검토 대기(구현 보고에 적음) [OPEN_COURSE]',
 ...
 #   ★코워크 셋째 판이 이 주석을 덮어 사라졌고 게이트가 잡았다 — 마커가 하는 일이 정확히 이것이다.
