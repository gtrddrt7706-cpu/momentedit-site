...
//   그 값은 아이폰 연락처에서 자동완성된 `+82 10-…` 이 그대로 저장된 것으로 읽었다.
//   ★정정(같은 날 · PHONE_AUTOFILL_82): 원래 번호는 `+82 10-7349-7706` 이고, 끝자리 6 을 자른 것은
//     우리 문의서 칸(inquiry.html)이었다 — 숫자만 남긴 12자를 11자로 잘랐다. 그 칸은 scripts/audit/tel-autofill.mjs 가 지킨다.
//     아래 표본의 `7349-9770` 은 규칙을 재는 가상의 번호다(실제 고객 번호가 아니다).
...
for (const [inp, want] of [
  ['+82 10-7349-9770', '01073499770'],          // 자동완성 모양(가상 번호)
