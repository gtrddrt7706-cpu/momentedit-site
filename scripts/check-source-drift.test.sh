...
run index.html '16~24분으로 달라집니다.</div>' '30분으로 달라집니다.</div>'                # 보이는 시퀀스 표 · [WAVE_SOFT 2026-08-10] 큰 칸은 '20min' 하나 · 범위는 이 설명 문장이 진다(</div> 까지 무는 이유: 주석이 대신 맞지 않게)
run index.html '16~24m | The Ceremony' '30m | The Ceremony'               # FAQ 블록
run index.html 'Ceremony 16~24분' 'Ceremony 30분'                          # Service JSON-LD
run assets/sequence-modal.js '따라 16~24분으로 달라지고' '따라 30분으로 달라지고'      # 공용 진행표 모달(한글 표) · [WAVE_SOFT 2026-08-10] 소요 칸은 '20분' · 범위는 상세 문장이 진다
